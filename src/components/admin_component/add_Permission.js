...
import { addPermission } from '../../api/userManagementSlice';

function AddPermissionAlertDialog() {
  ...
  const handleSubmit = (event) => {
    ...
    if (Object.values(newErrors).every(error => !error)) {
      ...
      dispatch(addPermission(dataContainer));
      handleClose();
...
export default AddPermissionAlertDialog;
